...
contract OrganicCoin is Context, IERC20, Ownable {
    ...
    string private _name = "OrganicCoin";
    string private _symbol = "OC";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 40; // 0.4 %
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 20; // 0.2%
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _marketingFee = 30; // 0.3%
    uint256 private _previousmarketingFee = _marketingFee;
    address public marketingWallet = 0xA488Ce1e91A50A3085A8Ba7212B52dC71bC57f0E;
